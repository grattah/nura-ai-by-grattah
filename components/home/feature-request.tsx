...
export function FeatureRequest() {
  ...
  return (
    <Link
      ...
      className="px-6 flex flex-col gap-1.75 text-center items-center"
    >
      <p className="text-base font-semibold text-base-text leading-[100%]">
        Is there a feature you’d like to see?
      </p>
      <div className="flex gap-1.75 items-center">
        <p className="text-sm font-medium text-grey-c500 leading-[100%]">
