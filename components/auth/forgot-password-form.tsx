      ...
      {success ? (
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center text-center gap-3">
            <div className="p-4 rounded-full bg-mint-green/10 relative">
              <div className="p-3 rounded-full bg-mint-green">
          ...
          <div className="rounded-xl border border-[#E8E6DC] p-4">
            <p className="text-sm text-subtle leading-relaxed">
              If you registered using this email, a password reset link will
              arrive within a few minutes. Check your spam folder if you do not
              see it.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link
              href="/auth/login"
              className="w-full text-center text-mint-green py-2 font-medium hover:underline"
            >
              Back to login
            </Link>
          </div>
