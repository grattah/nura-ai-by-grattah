  ...
  return (
    <button
      ...
      className={cn(
        ...
        !showText &&
          !popular &&
          "bg-[#E8E6DC] size-10 grid place-items-center text-subtle shrink-0",
        showText &&
          "border border-[#C4CAC8] bg-transparent p-3 text-subtle w-full",
        popular && "bg-white p-2 shrink-0",
      )}
    ...
    >
      ...
      />
      {showText && (
        <span className="ml-1 font-medium text-sm max-2xs:text-[10px] text-[#727E7A] text-nowrap">
          {text}
        </span>
      )}
    </button>
